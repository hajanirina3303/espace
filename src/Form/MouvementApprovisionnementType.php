...
class MouvementApprovisionnementType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        ->add('numeroPiece',NumberType::class ,[
            ...
            'html5' => true,
            'required' => true,
            'attr' => ['placeholder' => 'Numero Piece appro','class' => 'form-control']
        ...
        ->add('description',HiddenType::class ,[
            'empty_data'=> 'Approvisionnement (banque)',
            'label' => 'Description (*)',
            'required' => false,
            'attr' => ['placeholder' => 'Approvisionnement (Banque)','class' => 'form-control'],
